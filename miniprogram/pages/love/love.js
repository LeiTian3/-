...
Page({
  ...
  _success1() {
    wx.redirectTo({       
      url: '../../pages/imge/imge?name=头部按摩&money=20'    
      })
    // this.popup1.hidePopup();
    this.triggerEvent("error")
  },
  ...
  _success2() {
    wx.redirectTo({       
      url: '../../pages/imge/imge?name=全身按摩&money=30'    
      })
    // this.popup1.hidePopup();
    this.triggerEvent("error")
  },
  ...
  _success3() {
    wx.redirectTo({       
      url: '../../pages/imge/imge?name=捏背背&money=15'    
      })
    // this.popup1.hidePopup();
    this.triggerEvent("error")
  },
  ...
  _success4() {
    wx.redirectTo({       
      url: '../../pages/imge/imge?name=神神秘秘小惊喜&money=55'    
      })
    // this.popup1.hidePopup();
    this.triggerEvent("error")
  },
  ...
  _success5() {
    wx.redirectTo({       
      url: '../../pages/imge/imge?name=奇奇怪怪小惊喜&money=75'    
      })
    // this.popup1.hidePopup();
    this.triggerEvent("error")
  }
